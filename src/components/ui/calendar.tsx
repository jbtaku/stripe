  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "relative h-10 pt-1 text-xl font-bold",
        caption_label: "hidden",
        dropdown_year:
          "absolute left-1 opacity-100 hover:opacity-70 [&>.rdp-vhidden]:hidden",
        dropdown_month:
          "absolute left-20 opacity-100 hover:opacity-70 [&>.rdp-vhidden]:hidden",
        nav_button: cn(
